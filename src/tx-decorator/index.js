...
const TX_PARAMS_DECORATOR = {
    [TX_TYPE.SEND]: noop, // decorateSendTxParams,
    [TX_TYPE.MULTISEND]: noop,
    [TX_TYPE.SELL]: noop, // decorateSellTxParams,
    [TX_TYPE.BUY]: noop, // decorateBuyTxParams,
    [TX_TYPE.SELL_ALL]: noop, // decorateSellAllTxParams,
    [TX_TYPE.CREATE_COIN]: noop,
    [TX_TYPE.DECLARE_CANDIDACY]: noop, // decorateDeclareCandidacyTxParams,
    ...
    [TX_TYPE.DELEGATE]: noop, // decorateDelegateTxParams,
