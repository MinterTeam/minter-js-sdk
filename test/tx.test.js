...
describe('prepareTx', () => {
    ...
    describe('redeem check', () => {
        ...
        test('should work prepareSignedTx', shouldWorkPrepareSignedTx(txParams, {privateKey, password}, validTxHex));
        test('should work prepareTx', shouldWorkPrepareTx(txParams, {privateKey, password}, validTxHex));
...
function shouldWorkPrepareSignedTx(txParams, options, validTxHex) {
    return function test() {
        const tx = prepareSignedTx(txParams, options);
...
function shouldWorkPrepareTx(txParams, options, validTxHex) {
    return function test() {
