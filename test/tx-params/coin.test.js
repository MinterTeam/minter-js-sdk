...
describe('BuyTxParams', () => {
    ...
    test('default maxSellAmount', () => {
        ...
        expect(txParams)
            .toEqual({
                ...validTxParams,
                txData: Buffer.from([238, 138, 66, 69, 76, 84, 67, 79, 73, 78, 0, 0, 136, 138, 199, 35, 4, 137, 232, 0, 0, 138, 77, 78, 84, 0, 0, 0, 0, 0, 0, 0, 142, 49, 77, 198, 68, 141, 147, 56, 193, 91, 10, 0, 0, 0, 0]),
            });
    });
